...
#
# Script generated by Vivado on Mon May 13 17:48:04 +0200 2024
...
#
# Usage        : Jupyter.sh
#                Jupyter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Jupyter.sh [-reset_run]
#                Jupyter.sh [-reset_log]
#                Jupyter.sh [-help]
#
...
#                script (type 'Jupyter.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Jupyter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_clock_converter_v2_1_28 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/769c/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_7 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/3c0c/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_dwidth_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Jupyter xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Jupyter -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Jupyter_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Jupyter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Jupyter.sh [-help]\n\
Usage: Jupyter.sh [-step]\n\
Usage: Jupyter.sh [-lib_map_path]\n\
Usage: Jupyter.sh [-reset_run]\n\
Usage: Jupyter.sh [-reset_log]\n\
Usage: Jupyter.sh [-keep_index]\n\
Usage: Jupyter.sh [-noclean_files]\n\n\
