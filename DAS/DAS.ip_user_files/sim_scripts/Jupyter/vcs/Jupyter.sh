...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_17 $vlogan_opts -sverilog +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_1 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_29 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_data_fifo_v2_1_28 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_protocol_converter_v2_1_29 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_clock_converter_v2_1_28 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/769c/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work blk_mem_gen_v8_4_7 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/3c0c/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_dwidth_converter_v2_1_29 $vlogan_opts +v2k +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/ec67/hdl" +incdir+"../../../../DAS.gen/sources_1/bd/Jupyter/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Jupyter xil_defaultlib.glbl -o Jupyter_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Jupyter_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Jupyter_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Jupyter_simv.daidir vcs_lib c.obj)
