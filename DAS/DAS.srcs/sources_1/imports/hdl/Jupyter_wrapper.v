...
module Jupyter_wrapper
  ...
  // IOBUF instantiation for adc_sdata_i_0
  IOBUF adc_sdata_iobuf_0 (
    .I(1'b0), // Drive '0' when acting as output, but usually, you don't drive an IOBUF's I with '0' for an input-only pin
    .IO(adc_sdata_0), // External connection
    .O(adc_sdata_i_0), // Connect this to internal logic if needed
    .T(adc_sdata_t_0)  // Tristate control
  );
  
    // IOBUF instantiation for adc_sdata_i_1
  IOBUF adc_sdata_iobuf_1 (
    .I(1'b0), // Drive '0' when acting as output, but usually, you don't drive an IOBUF's I with '0' for an input-only pin
    .IO(adc_sdata_1), // External connection
    .O(adc_sdata_i_1), // Connect this to internal logic if needed
    .T(adc_sdata_t_1)  // Tristate control
  );
  
    // IOBUF instantiation for adc_sdata_i_2
  IOBUF adc_sdata_iobuf_2 (
    .I(1'b0), // Drive '0' when acting as output, but usually, you don't drive an IOBUF's I with '0' for an input-only pin
    .IO(adc_sdata_2), // External connection
    .O(adc_sdata_i_2), // Connect this to internal logic if needed
    .T(adc_sdata_t_2)  // Tristate control
  );
  
    // IOBUF instantiation for adc_sdata_i_3
  IOBUF adc_sdata_iobuf_3 (
    .I(1'b0), // Drive '0' when acting as output, but usually, you don't drive an IOBUF's I with '0' for an input-only pin
    .IO(adc_sdata_3), // External connection
    .O(adc_sdata_i_3), // Connect this to internal logic if needed
    .T(adc_sdata_t_3)  // Tristate control
  );
  Jupyter Jupyter_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
