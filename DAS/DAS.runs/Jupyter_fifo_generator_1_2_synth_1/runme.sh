...
HD_PWD='D:/Thesis/DAS_v2/DAS/DAS.runs/Jupyter_fifo_generator_1_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jupyter_fifo_generator_1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jupyter_fifo_generator_1_2.tcl
