...
HD_PWD='D:/Thesis/DAS_v2/DAS/DAS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jupyter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jupyter_wrapper.tcl
