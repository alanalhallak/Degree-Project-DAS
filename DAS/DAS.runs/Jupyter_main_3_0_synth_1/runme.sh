...
HD_PWD='D:/Thesis/DAS_v2/DAS/DAS.runs/Jupyter_main_3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jupyter_main_3_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jupyter_main_3_0.tcl
