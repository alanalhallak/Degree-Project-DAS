...
HD_PWD='D:/Thesis/DAS_v2/DAS/DAS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Jupyter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Jupyter_wrapper.tcl -notrace
