...
HD_PWD='D:/Thesis/DAS_v2/DAS/DAS.runs/Jupyter_fifo_generator_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jupyter_fifo_generator_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jupyter_fifo_generator_1_1.tcl
