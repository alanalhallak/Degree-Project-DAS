...
HD_PWD='D:/Thesis/DAS_v2/DAS/DAS.runs/Jupyter_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jupyter_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jupyter_axi_gpio_0_0.tcl
